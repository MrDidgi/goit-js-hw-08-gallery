...
const markupToAppend = (0, _markupMaker.galleryMapping)((0, _object.galleryItems));
...
const imagePreview = function(event) {
    ...
    if (divLightbox.classList.contains("is-open")) return;
...
},{"../src/object":"1n8dR","../src/markupMaker":"dzwxQ"}],"1n8dR":[function(require,module,exports) {
...
},{}],"dzwxQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "galleryMapping", ()=>galleryMapping);
const galleryMapping = function(arr) {
    return arr.map(({ preview , description , original  })=>`<li class='gallery__item'>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire4c75")
